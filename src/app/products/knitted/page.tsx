...
export default function KnittedFabricsPage() {
    const { t } = useTranslate()

    const sections = [
        {
            id: 'weft',
            title: t('products.knitted_fabrics.categories.weft'),
            items: KNITTED_PRODUCTS.filter(p => p.category === 'weft')
        },
        {
            id: 'functional',
            title: t('products.knitted_fabrics.categories.functional'),
            items: KNITTED_PRODUCTS.filter(p => p.category === 'functional')
        },
        {
            id: 'warp',
            title: t('products.knitted_fabrics.categories.warp'),
            items: KNITTED_PRODUCTS.filter(p => p.category === 'warp')
        }
    ]
                                                ...
                                                <div className="p-8 space-y-4">
                                                    ...
                                                    <div className="pt-4 border-t border-slate-50 grid grid-cols-2 gap-y-3 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                                                        ...
                                                        <div className="col-span-2 pt-2">
                                                            <Link
                                                                href={`/products/knitted/${product.id}`}
