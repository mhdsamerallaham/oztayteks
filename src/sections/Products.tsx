    ...
    <Section id="products" bg="default">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="group flex flex-col items-center text-center space-y-6">
            ...
            <div className="max-w-md mx-auto space-y-4">
              <h3 className="text-2xl lg:text-3xl font-heading font-bold text-slate-900 group-hover:text-amber-700 transition-colors">
        ...
        <div className="text-center mt-16">
          <Link href="/products">
            <Button variant="outline" size="lg" className="min-w-[200px] border-slate-300 text-slate-700 hover:border-amber-700 hover:text-amber-700">
